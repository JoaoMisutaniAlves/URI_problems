...
value %= 1
print("%d moeda(s) de R$ 0.50"%(value/0.50))
value %= 0.50
print("%d moeda(s) de R$ 0.25"%(value/0.25))
value %= 0.25
print("%d moeda(s) de R$ 0.10"%(value/0.10))
value %= 0.10
print("%d moeda(s) de R$ 0.05"%(value/0.05))
value %= 0.05
print("%.0f moeda(s) de R$ 0.01"%(value/0.01))